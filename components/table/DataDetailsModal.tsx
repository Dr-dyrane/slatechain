...
export function DataDetailsModal<TData extends Record<string, any>>({ open, onClose, data, columns }: DataDetailsModalProps<TData>) {
          ...
          <AlertDialogContent>
              <AlertDialogHeader>
                  <AlertDialogTitle>Row Details</AlertDialogTitle>
                    <AlertDialogDescription>View or manage the selected row</AlertDialogDescription>
              </AlertDialogHeader>
