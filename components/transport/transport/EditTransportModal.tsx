// src/components/transport/transport/EditTransportModal.tsx
"use client"
...
export function EditTransportModal({ open, onClose, transport }: EditTransportModalProps) {
            ...
            <AlertDialogContent className="w-full max-w-md rounded-2xl sm:max-w-lg mx-auto max-h-[80vh] overflow-y-auto">
                <AlertDialogHeader>
                    <div className="flex justify-center items-center relative">
                        <AlertDialogTitle>Edit Transport</AlertDialogTitle>
                        <button
                            onClick={handleClose}
                    ...
                    <AlertDialogDescription>Update transport details.</AlertDialogDescription>
                </AlertDialogHeader>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                    ...
                    <div>
                        ...
                        <Select onValueChange={handleTypeChange} defaultValue={transport.type}>
                    ...
                    <div>
                        ...
                        <Select onValueChange={handleStatusChange} defaultValue={transport.status}>
                            <SelectTrigger className="w-full">
                    ...
                    <div>
                        ...
                        <Select onValueChange={handleCarrierChange} defaultValue={transport.carrierId}>
                            <SelectTrigger className="w-full">
