// src/components/logistics/DeleteShipmentModal.tsx
"use client";
...
import { z } from "zod";
import { removeShipment } from "@/lib/slices/shipmentSlice";
...
export const DeleteShipmentModal = <TData extends Record<string, any>>({
    open,
    onClose,
    data,
    deleteModalTitle,
